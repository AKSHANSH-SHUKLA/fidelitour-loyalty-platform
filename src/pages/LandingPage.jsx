      ...
      <section id="features" className="py-24 bg-white border-y border-[#E7E5E4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FeatureCard
              icon={Settings2}
              title="Dynamic Card Visuals"
              description="Upload your logo, select typography, and instantly switch between traditional 'Stamp Overlay' vs 'Dynamic Point Tracker' visuals."
            />
            <FeatureCard
              icon={MapPin}
              title="Geolocalisation Push"
              description="Detect when a customer is within a 50-meter radius of your shop. Send automated, cooldown-protected push notifications offering them a micro-deal to step inside."
            />
            <FeatureCard
              icon={ScanLine}
              title="Seamless Visit Tracking"
              description="A single scan interface. Input the amount paid, scan the barcode, and auto-route them into intelligent lifetime value metrics and reward tiers."
            />
            <FeatureCard
              icon={BrainCircuit}
            ...
            >
              <div className="bg-[#FDFBF7] rounded-2xl p-6 flex flex-col items-center">
                ...
                <div className="w-full mb-8">
                  <p className="text-center text-sm text-[#57534E] mb-4 font-medium">Stamp Overlay Style</p>
                  <div className="bg-white rounded-2xl p-6 border-2 border-[#B85C38] shadow-lg">
                    ...
                    <div className="bg-[#F3EFE7] rounded-xl p-4 mb-4">
                      <p className="text-center text-xs text-[#57534E] mb-3">Stamps Earned</p>
                      <div className="flex justify-center gap-2">
                        {[1,2,3,4,5,6,7,8,9].map((i) => (
                          <div key={i} className={`w-6 h-6 rounded-full ${i <= 7 ? 'bg-[#B85C38]' : 'bg-[#E7E5E4]'} flex items-center justify-center text-white text-xs font-bold`}>
                            {i <= 7 ? '✓' : ''}
                          </div>
                        ))}
                      </div>
                    </div>
                    <p className="text-center text-xs text-[#57534E]">7 of 10 stamps collected</p>
                  </div>
                </div>
              ...
              >
                <div className="w-full space-y-3">
                  ...
                  <div className="flex items-end justify-center gap-2 h-32">
                    <div className="w-8 bg-[#B85C38]/40 rounded-t" style={{ height: '60%' }}></div>
                    <div className="w-8 bg-[#B85C38]/60 rounded-t" style={{ height: '75%' }}></div>
                    <div className="w-8 bg-[#B85C38]/80 rounded-t" style={{ height: '90%' }}></div>
                    <div className="w-8 bg-[#B85C38] rounded-t" style={{ height: '100%' }}></div>
                    <div className="w-8 bg-[#4A5D23]/40 rounded-t" style={{ height: '65%' }}></div>
                  </div>
                  <div className="flex justify-center gap-2 text-xs text-[#57534E]">
                    <span>Mon</span>
                    <span>Tue</span>
                    <span>Wed</span>
                    <span>Thu</span>
                  ...
                  <div className="pt-3 border-t border-[#E7E5E4]">
                    <p className="text-sm font-bold text-[#1C1917]">€4,250 Revenue</p>
                    <p className="text-xs text-[#57534E]">↑ 12% from last week</p>
                  </div>
                </div>
              </DemoCard>
                  ...
                  <div className="bg-white border border-[#E7E5E4] rounded-lg p-3 text-left">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-[#57534E] truncate">Come back & earn double points today only!</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-black rounded-2xl p-2 mx-auto w-32">
                    <div className="bg-[#FDFBF7] rounded-xl p-3 text-center">
                      ...
                      <div className="bg-[#B85C38] rounded-lg p-2 mb-2">
                        ...
                        <p className="text-white/90 text-xs">+5 bonus points</p>
                      </div>
                      <p className="text-xs text-[#57534E]">Tap to view</p>
                    </div>
                  </div>

                  <div className="text-center text-sm">
                    <p className="text-[#57534E] text-xs">30 meter geofence</p>
                    <p className="text-[#B85C38] text-xs font-bold">312 customers nearby</p>
                  </div>
                </div>
              </DemoCard>
            </div>
      ...
      <section id="pricing" className="py-24 max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-10 rounded-3xl border border-[#E7E5E4] shadow-sm flex flex-col">
            ...
            <Link to="/register" className="block text-center w-full bg-[#F3EFE7] text-[#1C1917] font-semibold px-6 py-4 rounded-xl hover:bg-[#E7E5E4] transition-colors">Contact Enterprise</Link>
          </div>
        </div>
      </section>
